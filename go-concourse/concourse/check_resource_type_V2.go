...
func (team *team) CheckResourceTypeV2(pipelineName string, resourceTypeName string, version atc.Version) (atc.Check, bool, error) {
	...
	err = team.connection.Send(internal.Request{
		RequestName: atc.CheckResourceTypeV2,
		Params:      params,
