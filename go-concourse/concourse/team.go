...
type Team interface {
	...
	CheckResourceV2(pipelineName string, resourceName string, version atc.Version) (atc.Check, bool, error)
	CheckResourceTypeV2(pipelineName string, resourceTypeName string, version atc.Version) (atc.Check, bool, error)
