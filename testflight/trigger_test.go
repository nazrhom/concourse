...
var _ = Describe("A job with an input with trigger: true", func() {
	...
	It("triggers when the resource changes", func() {
		...
		fly("check-resource-experimental", "-r", inPipeline("some-resource"), "-f", "version:first-version", "-w")
		...
		fly("check-resource-experimental", "-r", inPipeline("some-resource"), "-f", "version:second-version", "-w")
