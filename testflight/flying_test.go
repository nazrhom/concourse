...
`
		...
		It("runs the task without error", func() {
			...
			fly("check-resource-experimental", "-r", pipelineName+"/some-resource", "-f", "version:first-version", "-w")
			...
			fly("check-resource-experimental", "-r", pipelineName+"/some-resource", "-f", "version:second-version", "-w")
